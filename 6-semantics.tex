...
\emph{semantic core}\index{spatial relation!semantic core}  of 
spatial relations, i.e. a core meaning that 
abstracts from discourse situations as far as possible 
\citep{tenbrink2007space}\index{Tenbrink, T.}, and, subsequently, what that 
...
like lines, points, vectors, half-planes and so forth \citep{levinson1996language}\index{Levinson, S. C.}. 
...
\paragraph*{Functional Constraints}\index{spatial relation!functional constraints}
...
\paragraph*{Contextual Factors}\index{spatial relation!contextual factors}
...
\paragraph*{Other Modeling Approaches}\index{spatial relation!spatial ontologies}\index{spatial relation!qualitative spatial reasoning}
