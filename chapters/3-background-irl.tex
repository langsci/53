...
with progress reported by \cite{steels2005planning}\index{Steels, L.}\index{Bleys, J.}, \cite{vandenbroeck2008irl}\index{Van den Broeck, W.}, and
recently by \cite{spranger2010irl,spranger2012irl}\index{Loetzsch, M.}\index{Pauw, S.}\index{Spranger, M.}.
...
also called \textsc{irl-network}\index{IRL-network|see{semantic structure}}, is shown in \figref{f:the-red-block-network}.
...
refer to concepts, categories etc. as \textsc{semantic entities}\index{semantic entity}.

IRL-networks consist of two types of nodes 
\begin{description}
\item[Cognitive operations,] also called \textsc{semantic operations},\index{cognitive operation}
...
As \cite{steels2000emergence}\index{Steels, L.} has argued,
...
into an output argument. This \textsc{multidirectionality}\index{cognitive operation!multidirectionality} of operations 
...
\citep{haddock1989computational,winograd1971procedures}\index{Haddock, N. J.}\index{Winograd, T.}, However, \textsc{shrdlu} misses the key aspects of grounding, active interpretation and conceptualization 
as a search process. Other work such as those by \cite{bailey1997modeling}\index{Bailey, D.}\index{Narayanan, S.}\index{Feldman, J.}
...
objects and events in the same framework is \citegen{roy2005semiotic}\index{Roy, D.}, which is comparable 
