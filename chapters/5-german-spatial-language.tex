...
\begin{description}
\item[Projective relations]\index{spatial relation!projective}-- sometimes also called \textsc{dimensional terms} 
...
\REF{e:der-vordere-block}, as adverb as in \REF{e:der-block-vorne} 
and as preposition as in \REF{e:der-block-vor-der-kiste}. 
\index{adjectives}
\ea
...
For instance, the following phrase \REF{e:stelle-den-stuhl-vor-den-schrank} uses the projective category
...
by a prepositional phrase, as in \REF{e:der-block-vorne-in-der-kiste}--\REF{e:der-block-links-von-der-kiste}:
\ea
...
is perspective marking. The following two example feature perspective markers. In \REF{e:der-block-vorne-von-dir-aus} an adverb is perspective marked, in \REF{e:der-block-links-der-kiste-von-dir-aus} a prepositional
...
perspective', see \REF{e:der-block-links-der-kiste-von-dir-aus}) and
