...
\begin{enumerate} 
\item hypothesize \textsc{invention}, \textsc{adoption} and \textsc{alignment}\index{alignment} \textsc{operators} for the syntax and semantics
...
like mine is \textsc{semantic ambiguity}\index{semantic ambiguity} which refers to the fact that natural
