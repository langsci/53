...
(see \citealt{steels2000language}\index{Steels, L.} for the general idea of language as a complex adaptive system), 
...
Proposals include things such as ``theory of mind'' \citep{dunbar1998theory}\index{Dunbar, R.} which
is the capacity to understand another individual's state of mind, 
``joint attention''\is{joint attention} \citep{carpenter1998social}\index{Tomasello, M.}\index{Nagell, K.}\index{Carpenter, M.}\index{Butterworth, G.}\index{Moore, C.}
...
\citep{tomasello1992social}\index{Tomasello, M.} and the ability and the urge to ``share intentions''\is{shared intentions} 
...
Portuguese or Catalan (e.g., see \citealt{pope1952latin}\index{Pope, M. K.} for French). 
...
to the behavior. 
This is actually called ``causation'' by \cite{tinbergen1963aims}\index{Tinbergen, N.} 
...
\citealt{schoenemann1999syntax}\index{Schoenemann, P.}).
