...
\textit{der Block vorne in der Kiste} (`in the front area of the box').\todo[inline]{check translation}}
...
I use a particular design pattern called \textsc{actual-potential}.\index{design pattern!actual-potential}%
...
The actual-potential\index{design pattern!actual-potential} technique allows to 
...
the newly introduced syntactic and semantic function and classes are shown.\todo[inline]{reverse columns and rows?}}
\end{sidewaystable}
...
function {\footnotesize\tt adjectival} and semantic function {\footnotesize\tt modifier} and a constituent with syntactic function nominal and semantic function identifier onto a new unit.\todo{???} Hence, it builds hierarchy by introducing a new unit with two subunits -- 
