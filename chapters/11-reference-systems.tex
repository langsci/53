...
which eliminates it from routine processing but leaves it available for recruitment\index{recruitment} should it become necessary.
...
\end{equation}\todo[inline]{I replaced \textbackslash exp with \textbackslash operatorname\{exp\} here}
...
If success of the category is above $50\si{\percent}$, it is very hard for the alignment\index{alignment} mechanisms 
