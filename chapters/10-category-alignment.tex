...
A clear increase in the number of categories\is{measures!number of categories} for the two conditions \emph{smaller angle distance} and 
...
a proximal one via \emph{semantic inference}\is{semantic inference} a mechanism
